...
public class Quilmes extends Clientes {

    static String localidad = "Quilmes";
    private int gastoEnvio;
    
    public Quilmes(String nombre, String apellido, String direccion, float totalPagar) {
