...
public class Lanus extends Clientes {

    static String localidad = "Lanus";
    private int gastoEnvio;
    
    public Lanus(String nombre, String apellido, String direccion, float totalPagar) {
